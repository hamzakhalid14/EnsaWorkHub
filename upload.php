    ...
    if(in_array($fileActualExt,$allowed)){
        if($fileError==0){
           if($fileSize < 500000){
            ...
            $fileDestinatiion ='demandes/'. $fileNameNew;
move_uploaded_file( $fileTmpname,$fileDestinatiion);
           } else{
            echo" votre fichier est trés grand";
        }

        
        }
        else{
            echo" tu a un erreur de ce fichier";
        }
        

    }
    else{
        echo" tu n'a pas le droit de upload ce fichier";
    }
}
...
<div>
    <h1 class="text"> votre demande est bien effectue</h1>
    </div >
    <div class="container">
        <div class="form-container">
            <h2 class="text1"> Veuillez aller chez le responsable du magasin pour prendre votre article que tu a demandé</h2>
